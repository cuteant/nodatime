...
namespace NodaTime.Serialization.MessagePackSpan.Tests
{
    ...
    public class SystemDateTimeTests
    {
        ...
        public void LocalDateTimeToDateTime()
        {
            ...
            var resultDateTime = MessagePackSerializer.Deserialize<LocalDateTime>(localDateTimeBinary);

            Assert.Equal(dt, resultDateTime.ToDateTimeUnspecified());
        }
        ...
        public void DateTimeToLocalDateTime()
        {
            ...
            var bin = MessagePackSerializer.Serialize(LocalDateTime.FromDateTime(dt));
        ...
        public void LocalDateTimeToLocalDate()
        {
            ...
            Assert.Equal(ldt.Date, res.Date);
        }
        ...
        public void DateTimeToLocalDate()
        {
            ...
            var bin = MessagePackSerializer.Serialize(LocalDate.FromDateTime(dt));
            var res = MessagePackSerializer.Deserialize<LocalDate>(bin);
